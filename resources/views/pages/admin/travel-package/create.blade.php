            ...
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="d-block w-100 form-control" name="about" rows="10">{{old('about')}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="featured_event">Featured Event</label>
                        <input type="text" class="form-control" name="featured_event" placeholder="Acara Khusus" value="{{old('featured_event')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="foods" placeholder="Makanan Khas" value="{{old('foods')}}">
                    </div>
                    <div class="form-group">
