...
<div class="container">
    <nav class="row navbar navbar-expand-lg navbar-light bg-white">
        <a href="{{route('home')}}" class="navbar-brand">
            <img src="{{url('frontend/images/logo.png')}}" alt="Logo HyTrav">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navb">
            ...
            @guest
            <!-- Mobile Button -->
            <form class="form-check-inline d-sm-block d-md-none" type="button"
            ...
            <!-- Mobile Button -->
            <form class="form-check-inline d-sm-block d-md-none" action="{{url('logout')}}"
            method="POST">
            @csrf
